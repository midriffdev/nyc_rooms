				...
				<tr>
				   <td><input type="checkbox" class="checkproperties" value="<?= $post_id ?>"></td>
					<td class="title-container">
						...
						<div class="title">
							<h4><a href="<?= get_post_permalink( get_the_ID()).'?prpage=admin-available-properties' ?>"><?php echo get_the_title($post_id); ?></a></h4>
					...
					<td class="action">
					      <a href="<?= get_post_permalink( get_the_ID()).'?prpage=admin-available-properties' ?>"><i class="fa fa-eye"></i> View</a>
						<?php
						...
						?>
						<a href= "<?php echo get_site_url();?>/edit-property-admin/?prpage=admin-available-properties&&pid=<?php echo $post_id ;?>"><i class="fa fa-pencil"></i> Edit</a>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Properties Trashed Successfully</p>
        </div>

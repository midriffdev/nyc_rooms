<?php
/*
Template Name: Active Properties
*/
							...
							<tr class="property-id-<?php echo $post_id; ?>">
							   <td><input type="checkbox" class="checkproperties" value="<?= $post_id ?>"></td>
								<td class="title-container">
									...
									<div class="title">
										<h4><a href="<?= get_post_permalink( get_the_ID()) . '?prpage=active-properties' ?>"><?php echo get_the_title(); ?></a></h4>
								...
								<td class="action">
						            ...
						            ?>
								    <a href="<?= get_post_permalink( get_the_ID()) . '?prpage=active-properties' ?>"><i class="fa fa-eye"></i> View</a>
									<?php
									...
									?>
									<a href="<?= site_url().'/edit-property-owner/?pid='.$post_id .'&prpage=active-properties' ?>"><i class="fa fa-pencil"></i> Edit</a>
...
jQuery(document).ready(function($) {
	...
	jQuery('#sidebar-activeproperty').addClass('current');
});
</script>
<?php
get_footer();

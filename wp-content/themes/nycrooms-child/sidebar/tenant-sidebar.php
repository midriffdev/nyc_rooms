					...
					<ul class="my-account-nav">
						...
						<li class="list-has--submenu">
							...
							<ul class="list--submenu">
								<li><a href="<?php echo home_url(); ?>/active-properties-tenant/" >Active <span class="active-listing-no">4</span></a></li>
								<li><a href="<?php echo home_url(); ?>/past-properties-tenant/">Past <span class="rented-listing-no">3</span></a></li>
							</ul>
						</li>
						<li><a href="<?php echo home_url(); ?>/bookmarked-properties/"><i class="sl sl-icon-star"></i> Bookmarked Properties</a></li>
					</ul>

					<ul class="my-account-nav">
					    <li><a href="<?php echo home_url(); ?>/contracts-tenant/"><i class="sl sl-icon-book-open"></i> Contracts</a></li>

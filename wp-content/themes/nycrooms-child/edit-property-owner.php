<?php 
/*
Template Name:  Edit Property Owner
*/
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="submit-section prop_gallery">
			<form action="<?= site_url() ?>/edit-property-owner/?pid="<?= $propertyID ?> class="dropzone dropzone_media" ></form>
		</div>
		<!-- Section / End -->
		...
		<div class="submit-section prop_req_docs">
			<form action="<?= site_url() ?>/edit-property-owner/?pid="<?= $propertyID ?> class="dropzone dropzone_documents_update" ></form>
		</div>
		<!-- Section / End -->

...
if(empty($post) || ($post->post_type != 'contracts') || (get_post_meta($post->ID,'property_owner_email',true) != $current_user->user_email)){
	wp_redirect(get_site_url().'/property-owner/all-contracts'); 
}
...
<div class="contract-detail-container">		
	<div class="container">
		...
		<div class="row contractdetail--stageinnersection">
			<p style="color:#274abb"><a href="<?= site_url().'/property-owner/all-contracts/' ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></p>
			<div class="col-md-12">

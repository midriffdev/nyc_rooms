				...
				?>
							<tr class="property-id-<?php echo $post_id; ?>">
								...
								<td class="title-container">
									...
									<div class="title">
										<h4><a href="<?= get_post_permalink( get_the_ID()) . '?prpage=rented-properties' ?>"><?php echo get_the_title(); ?></a></h4>
										<span><?php echo $address; ?></span>
										<span class="table-property-price">$<?php echo ($price) ? $price : 'N/A'; ?>/ Weekly </span> <span class="rented--property">Rented</span>
										<?php 
										if($document_files){
											echo "</br></br>";
								...
								<td class="action">
								    <a href="<?= get_post_permalink( get_the_ID()) . '?prpage=rented-properties' ?>"><i class="fa fa-eye"></i> View</a>
									<?php
									...
									?>
									<a href="<?= site_url().'/edit-property-owner/?pid=' . $post_id . '&prpage=rented-properties'  ?>"><i class="fa fa-pencil"></i> Edit</a>
...
table.manage-table th:first-child {
 ...
 table.manage-table th:secand-child {
    width: 50%;
    border-radius: 3px 0 0 3px;
}

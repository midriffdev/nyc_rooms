			...
			<div class="dashboard-main--cont">
				...
				<tr>
					...
					<td class="title-container">
						...
						<div class="title">
							<h4><a href="<?= get_post_permalink( get_the_ID()).'?prpage=admin-rented-properties'  ?>"><?php echo get_the_title($post_id); ?></a></h4>
					...
					<td class="action">
						  <a href="<?= get_post_permalink( get_the_ID()).'?prpage=admin-rented-properties'  ?> "><i class="fa fa-eye"></i> View</a>
						<?php
